...
PRODUCT_COPY_FILES += \
    vendor/sony/shuang/proprietary/bin/adsprpcd:$(TARGET_COPY_OUT_SYSTEM)/bin/adsprpcd \
    vendor/sony/shuang/proprietary/bin/btnvtool:$(TARGET_COPY_OUT_SYSTEM)/bin/btnvtool \
    vendor/sony/shuang/proprietary/bin/dun-server:$(TARGET_COPY_OUT_SYSTEM)/bin/dun-server \
    vendor/sony/shuang/proprietary/bin/hci_qcomm_init:$(TARGET_COPY_OUT_SYSTEM)/bin/hci_qcomm_init \
    vendor/sony/shuang/proprietary/bin/irsc_util:$(TARGET_COPY_OUT_SYSTEM)/bin/irsc_util \
    vendor/sony/shuang/proprietary/bin/magnetic:$(TARGET_COPY_OUT_SYSTEM)/bin/magnetic \
    vendor/sony/shuang/proprietary/bin/mm-qcamera-daemon:$(TARGET_COPY_OUT_SYSTEM)/bin/mm-qcamera-daemon \
    vendor/sony/shuang/proprietary/bin/netmgrd:$(TARGET_COPY_OUT_SYSTEM)/bin/netmgrd \
    vendor/sony/shuang/proprietary/bin/qmuxd:$(TARGET_COPY_OUT_SYSTEM)/bin/qmuxd \
    vendor/sony/shuang/proprietary/bin/qseecomd:$(TARGET_COPY_OUT_SYSTEM)/bin/qseecomd \
    vendor/sony/shuang/proprietary/bin/radish:$(TARGET_COPY_OUT_SYSTEM)/bin/radish \
    vendor/sony/shuang/proprietary/bin/rfs_access:$(TARGET_COPY_OUT_SYSTEM)/bin/rfs_access \
    vendor/sony/shuang/proprietary/bin/rild:$(TARGET_COPY_OUT_SYSTEM)/bin/rild \
    vendor/sony/shuang/proprietary/bin/rmt_storage:$(TARGET_COPY_OUT_SYSTEM)/bin/rmt_storage \
    vendor/sony/shuang/proprietary/bin/sapd:$(TARGET_COPY_OUT_SYSTEM)/bin/sapd \
    vendor/sony/shuang/proprietary/etc/acdbdata/MTP/MTP_Bluetooth_cal.acdb:$(TARGET_COPY_OUT_SYSTEM)/etc/acdbdata/MTP/MTP_Bluetooth_cal.acdb \
    vendor/sony/shuang/proprietary/etc/acdbdata/MTP/MTP_General_cal.acdb:$(TARGET_COPY_OUT_SYSTEM)/etc/acdbdata/MTP/MTP_General_cal.acdb \
    vendor/sony/shuang/proprietary/etc/acdbdata/MTP/MTP_Global_cal.acdb:$(TARGET_COPY_OUT_SYSTEM)/etc/acdbdata/MTP/MTP_Global_cal.acdb \
    vendor/sony/shuang/proprietary/etc/acdbdata/MTP/MTP_Handset_cal.acdb:$(TARGET_COPY_OUT_SYSTEM)/etc/acdbdata/MTP/MTP_Handset_cal.acdb \
    vendor/sony/shuang/proprietary/etc/acdbdata/MTP/MTP_Hdmi_cal.acdb:$(TARGET_COPY_OUT_SYSTEM)/etc/acdbdata/MTP/MTP_Hdmi_cal.acdb \
    vendor/sony/shuang/proprietary/etc/acdbdata/MTP/MTP_Headset_cal.acdb:$(TARGET_COPY_OUT_SYSTEM)/etc/acdbdata/MTP/MTP_Headset_cal.acdb \
    vendor/sony/shuang/proprietary/etc/acdbdata/MTP/MTP_Speaker_cal.acdb:$(TARGET_COPY_OUT_SYSTEM)/etc/acdbdata/MTP/MTP_Speaker_cal.acdb \
    vendor/sony/shuang/proprietary/etc/firmware/a300_pfp.fw:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/a300_pfp.fw \
    vendor/sony/shuang/proprietary/etc/firmware/a300_pm4.fw:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/a300_pm4.fw \
    vendor/sony/shuang/proprietary/etc/firmware/adsp.b00:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/adsp.b00 \
    vendor/sony/shuang/proprietary/etc/firmware/adsp.b01:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/adsp.b01 \
    vendor/sony/shuang/proprietary/etc/firmware/adsp.b02:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/adsp.b02 \
    vendor/sony/shuang/proprietary/etc/firmware/adsp.b03:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/adsp.b03 \
    vendor/sony/shuang/proprietary/etc/firmware/adsp.b04:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/adsp.b04 \
    vendor/sony/shuang/proprietary/etc/firmware/adsp.b05:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/adsp.b05 \
    vendor/sony/shuang/proprietary/etc/firmware/adsp.b06:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/adsp.b06 \
    vendor/sony/shuang/proprietary/etc/firmware/adsp.b07:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/adsp.b07 \
    vendor/sony/shuang/proprietary/etc/firmware/adsp.mdt:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/adsp.mdt \
    vendor/sony/shuang/proprietary/etc/firmware/cmnlib.b00:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/cmnlib.b00 \
    vendor/sony/shuang/proprietary/etc/firmware/cmnlib.b01:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/cmnlib.b01 \
    vendor/sony/shuang/proprietary/etc/firmware/cmnlib.b02:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/cmnlib.b02 \
    vendor/sony/shuang/proprietary/etc/firmware/cmnlib.b03:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/cmnlib.b03 \
    vendor/sony/shuang/proprietary/etc/firmware/cmnlib.mdt:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/cmnlib.mdt \
    vendor/sony/shuang/proprietary/etc/firmware/cpp_firmware_v1_1_1.fw:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/cpp_firmware_v1_1_1.fw \
    vendor/sony/shuang/proprietary/etc/firmware/cpp_firmware_v1_1_6.fw:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/cpp_firmware_v1_1_6.fw \
    vendor/sony/shuang/proprietary/etc/firmware/cpp_firmware_v1_2_0.fw:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/cpp_firmware_v1_2_0.fw \
    vendor/sony/shuang/proprietary/etc/firmware/image/keymaste.b00:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/image/keymaste.b00 \
    vendor/sony/shuang/proprietary/etc/firmware/image/keymaste.b01:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/image/keymaste.b01 \
    vendor/sony/shuang/proprietary/etc/firmware/image/keymaste.b02:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/image/keymaste.b02 \
    vendor/sony/shuang/proprietary/etc/firmware/image/keymaste.b03:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/image/keymaste.b03 \
    vendor/sony/shuang/proprietary/etc/firmware/image/keymaste.mdt:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/image/keymaste.mdt \
    vendor/sony/shuang/proprietary/etc/firmware/isdbtmm.b00:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/isdbtmm.b00 \
    vendor/sony/shuang/proprietary/etc/firmware/isdbtmm.b01:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/isdbtmm.b01 \
    vendor/sony/shuang/proprietary/etc/firmware/isdbtmm.b02:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/isdbtmm.b02 \
    vendor/sony/shuang/proprietary/etc/firmware/isdbtmm.b03:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/isdbtmm.b03 \
    vendor/sony/shuang/proprietary/etc/firmware/isdbtmm.mdt:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/isdbtmm.mdt \
    vendor/sony/shuang/proprietary/etc/firmware/mba.b00:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/mba.b00 \
    vendor/sony/shuang/proprietary/etc/firmware/mba.mdt:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/mba.mdt \
    vendor/sony/shuang/proprietary/etc/firmware/modem.b00:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/modem.b00 \
    vendor/sony/shuang/proprietary/etc/firmware/modem.b01:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/modem.b01 \
    vendor/sony/shuang/proprietary/etc/firmware/modem.b02:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/modem.b02 \
    vendor/sony/shuang/proprietary/etc/firmware/modem.b03:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/modem.b03 \
    vendor/sony/shuang/proprietary/etc/firmware/modem.b04:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/modem.b04 \
    vendor/sony/shuang/proprietary/etc/firmware/modem.b05:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/modem.b05 \
    vendor/sony/shuang/proprietary/etc/firmware/modem.b08:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/modem.b08 \
    vendor/sony/shuang/proprietary/etc/firmware/modem.b15:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/modem.b15 \
    vendor/sony/shuang/proprietary/etc/firmware/modem.b16:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/modem.b16 \
    vendor/sony/shuang/proprietary/etc/firmware/modem.b17:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/modem.b17 \
    vendor/sony/shuang/proprietary/etc/firmware/modem.b18:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/modem.b18 \
    vendor/sony/shuang/proprietary/etc/firmware/modem.b19:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/modem.b19 \
    vendor/sony/shuang/proprietary/etc/firmware/modem.b20:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/modem.b20 \
    vendor/sony/shuang/proprietary/etc/firmware/modem.b21:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/modem.b21 \
    vendor/sony/shuang/proprietary/etc/firmware/modem.b22:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/modem.b22 \
    vendor/sony/shuang/proprietary/etc/firmware/modem.b25:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/modem.b25 \
    vendor/sony/shuang/proprietary/etc/firmware/modem.b26:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/modem.b26 \
    vendor/sony/shuang/proprietary/etc/firmware/modem.b27:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/modem.b27 \
    vendor/sony/shuang/proprietary/etc/firmware/modem.mdt:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/modem.mdt \
    vendor/sony/shuang/proprietary/etc/firmware/playready.b00:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/playready.b00 \
    vendor/sony/shuang/proprietary/etc/firmware/playready.b01:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/playready.b01 \
    vendor/sony/shuang/proprietary/etc/firmware/playready.b02:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/playready.b02 \
    vendor/sony/shuang/proprietary/etc/firmware/playready.b03:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/playready.b03 \
    vendor/sony/shuang/proprietary/etc/firmware/playready.mdt:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/playready.mdt \
    vendor/sony/shuang/proprietary/etc/firmware/tzlibasb.b00:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/tzlibasb.b00 \
    vendor/sony/shuang/proprietary/etc/firmware/tzlibasb.b01:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/tzlibasb.b01 \
    vendor/sony/shuang/proprietary/etc/firmware/tzlibasb.b02:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/tzlibasb.b02 \
    vendor/sony/shuang/proprietary/etc/firmware/tzlibasb.b03:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/tzlibasb.b03 \
    vendor/sony/shuang/proprietary/etc/firmware/tzlibasb.mdt:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/tzlibasb.mdt \
    vendor/sony/shuang/proprietary/etc/firmware/tzsuntory.b00:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/tzsuntory.b00 \
    vendor/sony/shuang/proprietary/etc/firmware/tzsuntory.b01:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/tzsuntory.b01 \
    vendor/sony/shuang/proprietary/etc/firmware/tzsuntory.b02:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/tzsuntory.b02 \
    vendor/sony/shuang/proprietary/etc/firmware/tzsuntory.b03:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/tzsuntory.b03 \
    vendor/sony/shuang/proprietary/etc/firmware/tzsuntory.mdt:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/tzsuntory.mdt \
    vendor/sony/shuang/proprietary/etc/firmware/wcnss.b00:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/wcnss.b00 \
    vendor/sony/shuang/proprietary/etc/firmware/wcnss.b01:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/wcnss.b01 \
    vendor/sony/shuang/proprietary/etc/firmware/wcnss.b02:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/wcnss.b02 \
    vendor/sony/shuang/proprietary/etc/firmware/wcnss.b04:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/wcnss.b04 \
    vendor/sony/shuang/proprietary/etc/firmware/wcnss.b06:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/wcnss.b06 \
    vendor/sony/shuang/proprietary/etc/firmware/wcnss.b07:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/wcnss.b07 \
    vendor/sony/shuang/proprietary/etc/firmware/wcnss.b08:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/wcnss.b08 \
    vendor/sony/shuang/proprietary/etc/firmware/wcnss.b09:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/wcnss.b09 \
    vendor/sony/shuang/proprietary/etc/firmware/wcnss.mdt:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/wcnss.mdt \
    vendor/sony/shuang/proprietary/etc/firmware/widevine.b00:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/widevine.b00 \
    vendor/sony/shuang/proprietary/etc/firmware/widevine.b01:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/widevine.b01 \
    vendor/sony/shuang/proprietary/etc/firmware/widevine.b02:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/widevine.b02 \
    vendor/sony/shuang/proprietary/etc/firmware/widevine.b03:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/widevine.b03 \
    vendor/sony/shuang/proprietary/etc/firmware/widevine.mdt:$(TARGET_COPY_OUT_SYSTEM)/etc/firmware/widevine.mdt \
    ...
    vendor/sony/shuang/proprietary/lib/hw/camera.vendor.msm8610.so:$(TARGET_COPY_OUT_SYSTEM)/lib/hw/camera.vendor.msm8610.so \
    vendor/sony/shuang/proprietary/lib/hw/sensors.msm8610.so:$(TARGET_COPY_OUT_SYSTEM)/lib/hw/sensors.msm8610.so \
    vendor/sony/shuang/proprietary/lib/libMiscTaAccessor.so:$(TARGET_COPY_OUT_SYSTEM)/lib/libMiscTaAccessor.so \
    vendor/sony/shuang/proprietary/lib/lib_asb_tee.so:$(TARGET_COPY_OUT_SYSTEM)/lib/lib_asb_tee.so \
    vendor/sony/shuang/proprietary/lib/libkeyctrl.so:$(TARGET_COPY_OUT_SYSTEM)/lib/libkeyctrl.so \
    vendor/sony/shuang/proprietary/lib/libloc_api_v02.so:$(TARGET_COPY_OUT_SYSTEM)/lib/libloc_api_v02.so \
    vendor/sony/shuang/proprietary/lib/libloc_ds_api.so:$(TARGET_COPY_OUT_SYSTEM)/lib/libloc_ds_api.so \
    vendor/sony/shuang/proprietary/lib/libmiscta.so:$(TARGET_COPY_OUT_SYSTEM)/lib/libmiscta.so \
    vendor/sony/shuang/proprietary/lib/libmm-qcamera.so:$(TARGET_COPY_OUT_SYSTEM)/lib/libmm-qcamera.so \
    vendor/sony/shuang/proprietary/lib/libmmcamera_interface.so:$(TARGET_COPY_OUT_SYSTEM)/lib/libmmcamera_interface.so \
    vendor/sony/shuang/proprietary/lib/libmmjpeg_interface.so:$(TARGET_COPY_OUT_SYSTEM)/lib/libmmjpeg_interface.so \
    vendor/sony/shuang/proprietary/lib/libqomx_core.so:$(TARGET_COPY_OUT_SYSTEM)/lib/libqomx_core.so \
    vendor/sony/shuang/proprietary/lib/libril.so:$(TARGET_COPY_OUT_SYSTEM)/lib/libril.so \
    vendor/sony/shuang/proprietary/lib/libta.so:$(TARGET_COPY_OUT_SYSTEM)/lib/libta.so \
    vendor/sony/shuang/proprietary/lib/soundfx/libposteffectwrapper.so:$(TARGET_COPY_OUT_SYSTEM)/lib/soundfx/libposteffectwrapper.so \
    vendor/sony/shuang/proprietary/lib/soundfx/libpreeffectwrapper.so:$(TARGET_COPY_OUT_SYSTEM)/lib/soundfx/libpreeffectwrapper.so \
